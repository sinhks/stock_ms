                ...
                <div class="sidebar pt-3">
                    ...
                    <nav class="mt-2">
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <li class="nav-item">
                                <a href="{{route('shopping.index')}}" class=" nav-link text-white {{ Request::routeIs('shopping.index') ? 'active' : '' }} ">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview sub-menu">
                                    ...
                                    <li class="nav-item"><a href="{{route('suppliers.index')}}" class=" nav-link text-white  {{ Request::routeIs('suppliers.index') ? 'active' : '' }} "><i class="fa-solid fa-truck-field nav-icon"></i> Supplier</a></li>
                                    
                                    
                                    <li class="nav-item"><a href="{{route('categories.index')}}" class=" nav-link text-white {{ Request::routeIs('categories.index') ? 'active' : '' }} "><i class="fa-solid fa-list nav-icon"></i> Category</a></li>
