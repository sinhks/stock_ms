...
<?php $__env->startSection('content'); ?>
        ...
        <div class="text-success fs-3 mt-3 mb-3">Create Order</div>
    ...
    <?php endif; ?>
        ...
        <form action="<?php echo e(route('orders.store')); ?>" method="POST" class="card p-5">
            ...
            <div class="form-group">
                ...
                <input type="number" name="total_amount" class="form-control" value="<?php echo e(old('total_amount')); ?>" required>
            </div>
            
            
            <div class="form-group">
                <label for="price">Payment method:</label>
                <input type="number" name="payment_method" class="form-control"  value="<?php echo e(old('payment_method')); ?>" required>
            </div>
            <div class="form-group">
                <label for="price">Billing address:</label>
                <input type="number" name="billing_address" class="form-control"  value="<?php echo e(old('billing_address')); ?>" required>
            </div>
            <div class="form-group">
                <label for="price">Shipping address:</label>
                <input type="number" name="shipping_address" class="form-control"  value="<?php echo e(old('shipping_address')); ?>" required>
            </div>
            <div class="form-group">
